...
static DirectX::SimpleMath::Vector3 Cross(
...
{
  *mtx = Matrix(*(m + 0), *(m + 1), *(m + 2), 0, *(m + 3), *(m + 4), *(m + 5), 0, *(m + 6), *(m + 7),
      *(m + 8), 0, *(m + 9), *(m + 10), *(m + 11), 1);
}
...
//------------------------------------------------------------------------------
void ComputeNormal(float v0x, float v0y, float v0z, float v1x, float v1y, float v1z, float v2x, float v2y,
    float v2z, float* nx, float* ny, float* nz)
{
  float e1x = v2x - v1x;
  float e1y = v2y - v1y;
  float e1z = v2z - v1z;
...
//------------------------------------------------------------------------------
bool tano::CreateBuffersFromMeshFaceted(
...
//------------------------------------------------------------------------------
bool tano::CreateBuffersFromBitmapFaceted(
