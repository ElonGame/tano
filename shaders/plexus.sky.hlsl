...
static float3 FOG_COLOR = float3(16, 16, 16) / 255;
static float3 SUN_COLOR = float3(128, 128, 100) / 255;
static float3 SUN_DIR = normalize(float3(-0.5, -0.4, -1.0));
static float SUN_POWER = 10;
